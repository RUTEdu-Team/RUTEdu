...
object QuestionBank {
    ...
    /**
     * Static questions for Lesson 4-5: "Stolice województw" (Provincial Capitals).
     */
    private val geo_4_5: List<Question> = listOf(
        MapQuiz(4501, "Wrocław", "Zaznacz Wrocław", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Wrocław to stolica województwa dolnośląskiego.")),
        MapQuiz(4502, "Bydgoszcz", "Zaznacz Bydgoszcz", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Bydgoszcz to jedna z dwóch stolic województwa kujawsko-pomorskiego.")),
        MapQuiz(4503, "Toruń", "Zaznacz Toruń", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Toruń to jedna z dwóch stolic województwa kujawsko-pomorskiego.")),
        MapQuiz(4504, "Lublin", "Zaznacz Lublin", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Lublin to stolica województwa lubelskiego.")),
        MapQuiz(4505, "Gorzów Wielkopolski", "Zaznacz Gorzów Wielkopolski", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Gorzów Wielkopolski to jedna z dwóch stolic województwa lubuskiego.")),
        MapQuiz(4506, "Zielona Góra", "Zaznacz Zieloną Górę", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Zielona Góra to jedna z dwóch stolic województwa lubuskiego.")),
        MapQuiz(4507, "Łódź", "Zaznacz Łódź", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Łódź to stolica województwa łódzkiego.")),
        MapQuiz(4508, "Kraków", "Zaznacz Kraków", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Kraków to stolica województwa małopolskiego.")),
        MapQuiz(4509, "Warszawa", "Zaznacz Warszawę", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Warszawa to stolica Polski i województwa mazowieckiego.")),
        MapQuiz(4510, "Opole", "Zaznacz Opole", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Opole to stolica województwa opolskiego.")),
        MapQuiz(4511, "Rzeszów", "Zaznacz Rzeszów", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Rzeszów to stolica województwa podkarpackiego.")),
        MapQuiz(4512, "Białystok", "Zaznacz Białystok", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Białystok to stolica województwa podlaskiego.")),
        MapQuiz(4513, "Gdańsk", "Zaznacz Gdańsk", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Gdańsk to stolica województwa pomorskiego.")),
        MapQuiz(4514, "Katowice", "Zaznacz Katowice", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Katowice to stolica województwa śląskiego.")),
        MapQuiz(4515, "Kielce", "Zaznacz Kielce", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Kielce to stolica województwa świętokrzyskiego.")),
        MapQuiz(4516, "Olsztyn", "Zaznacz Olsztyn", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Olsztyn to stolica województwa warmińsko-mazurskiego.")),
        MapQuiz(4517, "Poznań", "Zaznacz Poznań", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Poznań to stolica województwa wielkopolskiego.")),
        MapQuiz(4518, "Szczecin", "Zaznacz Szczecin", MapRegion.POLAND, "files/polish_provinces_and_capitals.geojson",
            Hint("Szczecin to stolica województwa zachodniopomorskiego."))
    )
